...
LISTA_PLATAFORMAS = [(0, ALTURA - 40, 
LARGURA, 40), (LARGURA / 2 - 50, ALTURA * 3 / 4, 100, 20), 
...
class Jogador(pygame.sprite.Sprite):
    ...
    def jump(self):
        #pular só se estiver sobre algo
        self.rect.x += 1
        hit = pygame.sprite.spritecollide(self, self.game.plataforma, False)
        self.rect.x -= 1
        if hit:
            self.vel.y = -20
...
class Game:
    ...
    def update(self):
        ...
        #Ver se o jogador toca em uma plataforma - caindo
